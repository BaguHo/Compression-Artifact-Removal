...
def load_images():
    ...
    train_dataset = load_dataset.CustomDataset(train_input_dataset, train_target_dataset)
        ...
        with torch.no_grad():
            ...
            for input_images, target_images in tqdm.tqdm(test_loader, desc="Testing"):
                ...
                for i in range(len(outputs)):
                    ...
                    ycrcb_target = np.transpose(ycrcb_target, (1, 2, 0)) * 255
                    ycrcb_output = np.transpose(ycrcb_output, (1, 2, 0)) * 255

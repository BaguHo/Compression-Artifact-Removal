...
def make_and_save_mini_imagenet():
    ...
    output_train_path = os.path.join(mini_imagenet_path, f"_original", "train")
    output_test_path = os.path.join(mini_imagenet_path, f"_original", "test")
    for i in range(1000):
...
def make_and_save_mini_imagenet_each_qf(QF):
    ...
    output_train_path = os.path.join(mini_imagenet_path, f"jpeg{QF}", "train")
    output_test_path = os.path.join(mini_imagenet_path, f"jpeg{QF}", "test")
    for i in range(1000):
        os.makedirs(os.path.join(output_train_path, str(i)), exist_ok=True)
        os.makedirs(os.path.join(output_test_path, str(i)), exist_ok=True)

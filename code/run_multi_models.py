...
def training_testing():
    ...
    for i in range(len(model_names)):
        ...
        for QF in QFs:
            ...
            save_result(
                model_name, dataset_name, dataset_name, accuracy, precision, QF=QF
            )
            ...
            jpeg_model = timm.create_model(
                "efficientnetv2_rw_m.agc_in1k", pretrained=True, num_classes=5
            ).to(device)
            ...
            # save jpeg model
            save_model(
                jpeg_model, os.path.join(os.getcwd(), "models"), "jpeg_model.pth"
            )

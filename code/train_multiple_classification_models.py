...
dataset_names = [
    f"ARCNN_ycrcb_{today_date}",
    f"BlockCNN_ycrcb_{today_date}",
    f"DnCNN_ycrcb_{today_date}",
    f"PxT_8x8_ycrcb_{today_date}",
]
...
if __name__ == "__main__":
    ...
    # cifar100 데이터셋 로드
    cifar100_train_dir = os.path.join(os.getcwd(), "datasets", "CIFAR100", "32x32", "original", "train")
    cifar100_test_dir = os.path.join(os.getcwd(), "datasets", "CIFAR100", "32x32", "original", "test")
